...
public class PrintIMethod extends PredefinedMethod {
    public PrintIMethod(Class classContainer) throws CodeGeneratorException {
        super("printI", new VoidType(), MethodForm.STATIC, classContainer);

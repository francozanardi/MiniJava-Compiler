...
public class PrintCMethod extends PredefinedMethod {
    public PrintCMethod(Class classContainer) throws CodeGeneratorException {
        super("printC", new VoidType(), MethodForm.STATIC, classContainer);

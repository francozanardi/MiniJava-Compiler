...
public class PrintBLnMethod extends PredefinedMethod {
    public PrintBLnMethod(Class classContainer) throws CodeGeneratorException {
        super("printBln", new VoidType(), MethodForm.STATIC, classContainer);

...
public class DivisionBinaryExpressionNode extends PrimitiveTypeBinaryExpressionNode {
    public DivisionBinaryExpressionNode(Token sentenceToken) {
        super(sentenceToken);
    }
    ...
    protected Instruction generateInstruction() {
        return new Instruction(ZeroArgumentInstruction.DIV);
    }
}

...
public class MultiplicationBinaryExpressionNode extends PrimitiveTypeBinaryExpressionNode {
    public MultiplicationBinaryExpressionNode(Token sentenceToken) {
        super(sentenceToken);
    }
    ...
    protected Instruction generateInstruction() {
        return new Instruction(ZeroArgumentInstruction.MUL);
    }
}

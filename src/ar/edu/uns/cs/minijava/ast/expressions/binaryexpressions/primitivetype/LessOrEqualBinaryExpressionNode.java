...
public class LessOrEqualBinaryExpressionNode extends PrimitiveTypeBinaryExpressionNode {
    public LessOrEqualBinaryExpressionNode(Token sentenceToken) {
        super(sentenceToken);
    }
    ...
    protected Instruction generateInstruction() {
        return new Instruction(ZeroArgumentInstruction.LE);
    }
}

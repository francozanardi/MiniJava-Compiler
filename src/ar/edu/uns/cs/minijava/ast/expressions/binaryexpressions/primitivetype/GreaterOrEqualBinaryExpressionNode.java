...
public class GreaterOrEqualBinaryExpressionNode extends PrimitiveTypeBinaryExpressionNode {
    public GreaterOrEqualBinaryExpressionNode(Token sentenceToken) {
        super(sentenceToken);
    }
    ...
    protected Instruction generateInstruction() {
        return new Instruction(ZeroArgumentInstruction.GE);
    }
}
